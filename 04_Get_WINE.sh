...
#wine-desktop-files
sudo apt install --yes wine-desktop-files exe-thumbnailer wine-binfmt binfmt-support
# wine-binfmt binfmt-support <- these two allow double clicking .exe files to run them.
